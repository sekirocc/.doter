...
(custom-set-faces
  ...
  '(tab-bar ((t (:background "#1e1e1e" :height 115))))
  ...
  '(treemacs-directory-collapsed-face ((t (:family "IBM Plex Mono" :weight normal :height 115 :underline nil :inherit unspecified :foreground "#57D8D4"))))
  '(treemacs-directory-face ((t (:family "IBM Plex Mono" :weight normal :height 115 :underline nil :inherit unspecified :foreground "#57D8D4"))))
  '(treemacs-file-face ((t (:family "IBM Plex Mono" :weight normal :height 115 :underline nil :inherit unspecified :foreground "#C6B8AD"))))
  '(treemacs-git-added-face ((t (:family "IBM Plex Mono" :weight normal :height 115 :underline nil :inherit unspecified :foreground "#C6B8AD"))))
  '(treemacs-git-conflict-face ((t (:family "IBM Plex Mono" :weight normal :height 115 :underline nil :inherit unspecified :foreground "#C6B8AD"))))
  '(treemacs-git-ignored-face ((t (:family "IBM Plex Mono" :weight normal :height 115 :underline nil :inherit unspecified :foreground "#C6B8AD"))))
  '(treemacs-git-modified-face ((t (:family "IBM Plex Mono" :weight normal :height 115 :underline nil :inherit unspecified :foreground "#D0BF68"))))
  '(treemacs-git-renamed-face ((t (:family "IBM Plex Mono" :weight normal :height 115 :underline nil :inherit unspecified :foreground "#C6B8AD"))))
  '(treemacs-git-unmodified-face ((t (:family "IBM Plex Mono" :weight normal :height 115 :underline nil :inherit unspecified :foreground "#C6B8AD"))))
  '(treemacs-git-untracked-face ((t (:family "IBM Plex Mono" :weight normal :height 115 :underline nil :inherit unspecified :foreground "#C6B8AD"))))
  '(treemacs-root-face ((t (:family "IBM Plex Mono" :weight normal :height 115 :underline nil :inherit unspecified :foreground "#57D8D4"))))
  '(treemacs-tags-face ((t (:family "IBM Plex Mono" :weight normal :height 115 :underline nil :inherit unspecified :foreground "#C6B8AD"))))
