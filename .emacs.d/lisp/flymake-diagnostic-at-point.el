...
(defface flymake-diagnostic-at-point-posframe-background-face
  '((t))
  "The foreground/background color of the flymake-diagnostic-at-point posframe frame.
Only the `background' and 'foreground' is used in this face."
  :group 'flymake-diagnostic-at-point)
...
(defun flymake-diagnostic-at-point-display-posframe (text)
  ...
  (posframe-show
   ...
   :foreground-color (face-foreground 'flymake-diagnostic-at-point-posframe-background-face nil t)
